...
{
    /// <inheritdoc />
    public partial class AddedRecipeAndStep : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Recipes_Methods_MethodId",
                        column: x => x.MethodId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WaterAmount = table.Column<double>(type: "REAL", nullable: true)
                },
                constraints: table =>
                {
